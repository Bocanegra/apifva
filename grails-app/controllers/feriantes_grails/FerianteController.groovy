    ...
    def importing() {
        ...
        for (int row = 1; row < sheet.getRows(); row++) {
            ...
            Feriante feriante = new Feriante(
                    ...
                    superficie1: preparaCelda(superficie1, Integer),
                    precio1: preparaCelda(precio1, Integer),
                    superficie2: preparaCelda(superficie2, Integer),
                    precio2: preparaCelda(precio2, Integer),
